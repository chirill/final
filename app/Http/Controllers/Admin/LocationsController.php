...
class LocationsController extends Controller
{
    ...
    public function show($id)
    {
        ...
        $computers = \App\Computer::where('location_id', $id)->get();$printers = \App\Printer::where('location_id', $id)->get();

        $location = Location::findOrFail($id);

        return view('admin.locations.show', compact('location', 'computers', 'printers'));
    }
