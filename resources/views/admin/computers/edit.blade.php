...
@section('content')
    ...
    {!! Form::model($computer, ['method' => 'PUT', 'route' => ['admin.computers.update', $computer->id], 'files' => true,]) !!}
        ...
        <div class="panel-body">
            ...
            <div class="row">
                <div class="col-xs-12 form-group">
                    ...
                    @if ($computer->factura)
                        <a href="{{ asset(env('UPLOAD_PATH').'/' . $computer->factura) }}" target="_blank">Download file</a>
                    @endif
