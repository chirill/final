                    ...
                    @if (count($users) > 0)
                        @foreach ($users as $user)
                            <tr data-entry-id="{{ $user->id }}">
                                ...
                                <td field-key='role'>{{ $user->role->name or 'not set' }}</td>
                                <td field-key='location'>{{ $user->location->name or 'not set' }}</td>
                                <td field-key='department'>{{ $user->department->name or 'not set' }}</td>
                                <td field-key='status'>{{ $user->status->name or 'not set' }}</td>
                                <td>
                                    @can('user_view')
